        ...
        "input": {
            ...
            "moreInfo": [
                ...
                },
                {
                    ...
                    label: "Query",
                    mapping: function(e) {
                        return e ? e.replace(/</g, "&lt;").replace(/>/g, "&gt;") : "</br>"
                    }
                },
                {
                    "field": "filter_parameter",
                ...
                {
                    "field": "source_type_tenable",
                    "label": "Source Type",
                    mapping: function (field) {
                        if (field === 'cumulative') {
                            return 'Usable';
                        } else if(field === 'patched'){
                            return 'Mitigated';
                        } else {
                            return 'Scan Result';
                        }
                ...
                "input": {
                    ...
                    "entity": [
                        ...
                        },
                        {
                            ...
                            "type": TextControl,
                            "required": false,
                            "help": "Enter a query. If not entered, the App will pull all Scan data"
                        },
                        {
                            "field": "source_type_tenable",
                            "label": "Source Type",
                            "type": SingleInputControl,
                            "required": false,
                            "help": "If Query has been entered, please select a sourcetype.",
                            "defaultValue": "cumulative",
                            "options": {
                                "disableSearch": true,
                                "autoCompleteFields": [{"label": "Scan Result", "value": "scan_result"}, {"label": "Cumulative", "value": "cumulative"}, {"label": "Mitigated", "value": "patched"}]
                            }
                        },
                        {
                            "field": "filter_parameter",
                            ...
                            "options": {
                                "disableSearch": true,
                                "autoCompleteFields": [{"label": "Usable", "value": "usable"}, {"label": "Managed", "value": "managed"}]
                            }
                        },
                        {
                            "field": "interval",
